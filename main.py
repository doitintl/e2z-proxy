...
def submit_ticket(requester_id, subject, description,token, tag):
    new_ticket = {
        'ticket': {
            ...
            "priority": 0,
            "additional_collaborators": ['scott@doit-intl.com', 'james@doit-intl.com', 'kahina@doit-intl.com', 'lewin@doit-intl.com','vadim@doit-intl.com','ytc@doit-intl.com','spenser@doit-intl.com'],
            "tags": [tag],
            "group_id": 25032363
        }
    }
